...
name: spec
description: >
  Designs and develops specs following the spec-driven method. Asks clarifying questions
  before proposing structure, and builds the spec section by section. Use when starting
  a large feature, before writing code.
---
...
This is the most important phase. Your job here is to **detect ambiguities and ask**, not to assume.
...
- Use concrete questions, not open-ended ones. Bad: "How do you imagine persistence?" Good: "Is persistence localStorage, IndexedDB, or a JSON file on disk?"
